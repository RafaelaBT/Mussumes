...
public class MussumesParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, T__19=20, T__20=21, VIR=22, AP=23, FP=24, ACH=25, 
		FCH=26, SC=27, ATTR=28, OPREL=29, WS=30, COMMENT=31, TRUE=32, FALSE=33, 
		ID=34, FLOAT=35, INT=36, STRING=37;
	public static final int
		RULE_prog = 0, RULE_decl = 1, RULE_declaravar = 2, RULE_tipo = 3, RULE_bloco = 4, 
		RULE_cmd = 5, RULE_cmdleitura = 6, RULE_cmdescrita = 7, RULE_cmdattrib = 8, 
		RULE_cmdselecao = 9, RULE_cmdrepeticao = 10, RULE_expr_or_bool = 11, RULE_expr = 12, 
		RULE_termo = 13, RULE_fator = 14, RULE_boolexpr = 15, RULE_booltermo = 16, 
		RULE_boolfator = 17, RULE_comparison = 18;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "decl", "declaravar", "tipo", "bloco", "cmd", "cmdleitura", "cmdescrita", 
			"cmdattrib", "cmdselecao", "cmdrepeticao", "expr_or_bool", "expr", "termo", 
			"fator", "boolexpr", "booltermo", "boolfator", "comparison"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'senaovis'", "'fazis'", "'enquantis'", "'+'", "'-'", "'*'", "'/'", "'||'", 
			"'&&'", "'!'", "','", "'('", "')'", "'{'", "'}'", "';'", "'='", null, 
			null, null, "'verdaderis'", "'falsis'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, "VIR", "AP", 
			"FP", "ACH", "FCH", "SC", "ATTR", "OPREL", "WS", "COMMENT", "TRUE", "FALSE", 
			"ID", "FLOAT", "INT", "STRING"
		};
	}
	...
	public final BlocoContext bloco() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 17179894656L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CmdleituraContext cmdleitura() throws RecognitionException {
		...
		try {
			...
			setState(87);
			match(ID);
			Variable var = verificaID(_input.LT(-1).getText()); var.setInitialized(true);
			setState(89);
			match(FP);
			setState(90);
			match(SC);
	...
	public final Expr_or_boolContext expr_or_bool() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_expr_or_bool);
		try {
			setState(180);
			_errHandler.sync(this);
	...
	public final BoolfatorContext boolfator() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_boolfator);
		try {
			setState(263);
			_errHandler.sync(this);
